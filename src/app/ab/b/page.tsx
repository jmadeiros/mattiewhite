...
// VERSION B: Wider spacing, caption below, no dim, no zoom
          ...
          <AnimatePresence mode="wait">
            {!showFullPortfolio ? (
              ...
              <motion.div key="full" initial={{ opacity: 0, x: 100 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 100 }} transition={{ duration: 0.5 }} className="max-w-7xl mx-auto">
                {/* VERSION B: Wider spacing (gap-8), caption below, NO dim, NO zoom */}
                  ...
                  <AnimatePresence>
                    {portfolioImages.map((item) => (
                      ...
                      >
                        ...
                        {/* Title below image on hover - NO dim overlay */}
